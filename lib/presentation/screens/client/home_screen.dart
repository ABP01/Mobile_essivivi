...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (_currentUser != null) {
        ...
        final allOrders = await _salesRepo.getCommandesByClient(
          _currentUser!.id,
        );
  ...
  List<Commande> get _filteredAndSortedOrders {
    List<Commande> filtered = _recentOrders.where((order) {
      final matchesSearch = order.id.toString().contains(
                          ...
                          if (_activeOrder!.statut == 'validated') {
                            Navigator.pushNamed(
                              ...
                              arguments: {
                                ...
                                'clientLatitude':
                                    _activeOrder!.deliveryLatitude,
                                'clientLongitude':
                                    _activeOrder!.deliveryLongitude,
                              },
                            );
                          } else {
                            Navigator.pushNamed(
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildFilterChip(
                            context,
                            AppLocalizations.of(context)!.onDelivery,
                            'on_delivery',
                          ),
                          _buildFilterChip(
                            context,
  ...
  Widget _buildFilterChip(
    ...
    final isSelected =
        ...
        statusKey ==
            'all'; // Temporary logic or just remove isSelected if not needed
      ...
      onTap: () {
        if (status == 'on_delivery') {
          ...
          Navigator.pushNamed(
            context,
            AppRoutes.shipmentDetails,
            arguments: {'title': title, 'id': id, 'status': status},
          );
        }
      },
      child: Container(
          ...
          children: [
            ...
            Container(
              ...
              child: product.imageUrl != null && product.imageUrl!.isNotEmpty
                  ...
                  : Icon(icon, color: color, size: 28), // Icône de fallback
            ),
            const SizedBox(height: 12),
            Text(
              product.name,
